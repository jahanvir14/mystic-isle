...
int main() //execution of the prgram starts from here
{
    printf("╔══════════════════════════════════════════╗\n");
    ...
    printf("╔══════════════════════════════════════════╗\n");
    printf("║ Before you, the trail splits into        ║\n");
    printf("║ two distinct paths, one leads to         ║\n");
            ...
            if (choice3 == 2)// for Riddle
            {
               ...
               if(strcasecmp(word, "CRYSTAL")==0) //riddle solution
               {
                ...
                if (choice4 == 1) //for friendly spirit
                {
                  ...
                  printf("With the help of Friendly Spirit, you reach the bed of the pond.\n There you see a dimly lit cave, where you find a shiny blue glass-like ball of power, the Crystal of Clarity.\n");
